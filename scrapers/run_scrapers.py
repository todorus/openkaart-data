...
WFSScraper(cbsRegionsWFS, 'cbsgebiedsindelingen:cbs_provincie_2016_gegeneraliseerd', '/Volumes/openkaart_data/provinces.geo.json', None).start()
WFSScraper(cbsRegionsWFS, 'cbsgebiedsindelingen:cbs_gemeente_2016_gegeneraliseerd', '/Volumes/openkaart_data/municipalities.geo.json', None).start()
